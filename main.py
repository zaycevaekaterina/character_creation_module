...
def attack(char_name: str, char_class: str) -> str:
    """Отображает был ли нанесен урон противнику и в каком размере."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный'
                f'{5 + randint(-3, -1)}')
    return f'{char_name} урон не нанесён'


def defence(char_name: str, char_class: str) -> str:
    """Отображает был блокирован противник и с каким размером урона."""
    if char_class == 'warrior':
    ...
    return f'{char_name} блокировка не применялась'


def special(char_name: str, char_class: str) -> str:
    """Отображает применялось ли игроком специальное умение, какое оно было."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Отображает характеристику героя и начинает тренировку."""
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — чтобы атаковать противника,'
          'defence — чтобы блокировать атаку противника или specia'
